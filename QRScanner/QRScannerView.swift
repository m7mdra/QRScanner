...
public class QRScannerView: UIView {
    private var metadataTypes:[AVMetadataObject.ObjectType] = [.code128,
                                      .code39,
                                      .code93,
                                      .ean13,
                                      .code128,
...
extension QRScannerView: AVCaptureMetadataOutputObjectsDelegate {
    public func metadataOutput(_ output: AVCaptureMetadataOutput, didOutput metadataObjects: [AVMetadataObject], from connection: AVCaptureConnection) {
        ...
        if let metadataObject = metadataObjects.first {
            guard let readableObject = previewLayer?.transformedMetadataObject(for: metadataObject) as? AVMetadataMachineReadableCodeObject, metadataTypes.contains(readableObject.type) else { return }
